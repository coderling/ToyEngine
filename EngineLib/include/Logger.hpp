...
void Log(ELOG_LEVEL level, const char *file, const char *function,
         const int &line, const ArgsType... args)
{
...
template <bool throwException, typename... ArgsType>
void LogFormat(ELOG_LEVEL level, const char *file, const char *function,
               const int &line, const std::string_view &format,
               const ArgsType &...args)
{
...
#define LOG(level, exception, ...)                                             \
    do                                                                         \
        {                                                                      \
            Log<exception>(level, __FILE__, __FUNCTION__, __LINE__,            \
                           ##__VA_ARGS__);                                     \
    } while (false)
...
#define LOG_FORMAT(level, exception, format, ...)                              \
    do                                                                         \
        {                                                                      \
            LogFormat<exception>(level, __FILE__, __FUNCTION__, __LINE__,      \
                                 format, ##__VA_ARGS__);                       \
    } while (false)
...
#define LOG_WARNING_FORMAT(format, ...)                                        \
    do                                                                         \
        {                                                                      \
            LOG_FORMAT(Toy::Debug::LOG_LV_WARNING, false, format,              \
                       ##__VA_ARGS__);                                         \
    } while (false)
...
#define LOG_ERROR_FORMAT(format, ...)                                          \
    do                                                                         \
        {                                                                      \
            LOG_FORMAT(Toy::Debug::LOG_LV_ERROR, false, format,                \
                       ##__VA_ARGS__);                                         \
    } while (false)
...
#define LOG_FATAL_ERROR_FORMAT(format, ...)                                    \
    do                                                                         \
        {                                                                      \
            LOG_FORMAT(Toy::Debug::LOG_LV_FATAL_ERROR, false, format,          \
                       ##__VA_ARGS__);                                         \
    } while (false)
...
#define LOG_FATAL_ERROR_EXCEPTION_FORMAT(format, ...)                          \
    do                                                                         \
        {                                                                      \
            LOG_FORMAT(Toy::Debug::LOG_LV_FATAL_ERROR, true, format,           \
                       ##__VA_ARGS__);                                         \
    } while (false)
}  // namespace Toy::Debug